...
<body>
    <?php
        ...
        if (isset($_GET['logout']) && $_GET['logout'] === 'true') {
            ...
            // If the user directly accesses userLogOut.php without logging out, redirect to the login page or display an error
            header("Location: userLogIn.php");
            exit();
        }
    ?>
    ...
    <script>
        ...
        function fadeOutMessage() {
            setTimeout(function () {
                ...
                // Redirect to userStartPage.php after the message is displayed
                window.location.href = 'userStartPage.php';
