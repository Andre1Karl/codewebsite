    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">User Comments</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">User Comments</h5>
        ...
        <?php
            ...
            if (isset($_GET['search'])) {
                ...
                $sql = "SELECT commentNum, userName, userComment, commentTime FROM usermessage 
                        WHERE commentNum LIKE '%$searchKeyword%' OR 
                              userName LIKE '%$searchKeyword%' OR 
                              userComment LIKE '%$searchKeyword%' OR 
                              commentTime LIKE '%$searchKeyword%'";
            } else {
                $sql = "SELECT commentNum, userName, userComment, commentTime FROM usermessage";
            }
            ...
            echo '<table>';
            echo '<tr><th>Comment #</th><th>Username</th><th>Comment</th><th>Date & Time</th><th>Action</th></tr>';

            if ($result->num_rows > 0) {
                // Output data of each row
                while ($row = $result->fetch_assoc()) {
                    echo '<tr>';
                    echo '<td>' . $row['commentNum'] . '</td>';
                    echo '<td>' . $row['userName'] . '</td>';
                    echo '<td>' . $row['userComment'] . '</td>';
                    echo '<td>' . $row['commentTime'] . '</td>';
                    echo '<td><a href="deleteComment.php?action=delete&commentNum=' . $row['commentNum'] . '" onclick="return confirm(\'Are you sure you want to delete this comment?\')">Delete</a></td>';
                    echo '</tr>';
                }
            } else {
